...
import {
  ...
  StepFrame,
  ProgressRail,
} from "@/components/forms/scout-report-ui";

import { saveScoutReport } from "./actions";
...
export default function NewReportPage() {
  ...
  const handleSubmit = async () => {
    ...
    const result = await saveScoutReport(data);
        ...
        <div className="space-y-6">
          <GlassCard className="p-6 bg-stone-900 border-stone-800 text-white rounded-none border-2 shadow-none">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="font-mono text-sm font-bold text-stone-500">/ 5.0</span>
            </div>
